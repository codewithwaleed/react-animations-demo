import { tada, headShake, rotateOut, swing, jello, rotateIn, flip } from "react-animations";
...
export default function Dance() {
  ...
  return (
    ...
    ${css(
      ...
      >
        <h2 className="title">Dance Me In</h2>
      </div>
      <button className="button" onClick={handleDance}>Dance</button>
    </div>
  );
}
